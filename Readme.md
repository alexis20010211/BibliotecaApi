...
Este proyecto implementa un **backend completo** para la gestión de bibliotecas universitarias usando **Java y Spring Boot**, integrando **persistencia en base de datos relacional**, **seguridad con JWT**, y control de acceso por roles (`ADMIN` y `USUARIO`).  
